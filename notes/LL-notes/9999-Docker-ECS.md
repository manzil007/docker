...
# docker build -t myops-reports .

4) After the build completes, tag your image so you can push the image to this repository:

# docker tag myops-reports:latest XXXXXXXXXXXX.dkr.ecr.us-east-1.amazonaws.com/myops-reports:latest

5) Run the following command to push this image to your newly created AWS repository:

# docker push XXXXXXXXXXXX.dkr.ecr.us-east-1.amazonaws.com/myops-reports:latest
```
